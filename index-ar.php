...
<body data-home-page="" data-home-page-title="" class="u-body u-overlap u-overlap-contrast u-overlap-transparent u-xl-mode" data-lang="ar">
  ...
  <section class="u-align-left u-clearfix u-image u-shading u-section-1" src="" data-image-width="1500" data-image-height="1000" id="Home">
    <div class="u-clearfix u-sheet u-sheet-1">
          ...
          <div class="u-align-center u-form u-form-1">
            <form class="u-clearfix u-form-spacing-28 u-inner-form" style="padding: 0px;" source="email" name="form" method="POST">
              ...
              <div class=" u-form-message u-label-none">
                <textarea dir="rtl" rows="2" cols="50" id="message-5a14" name="notes" class="u-border-2 u-border-custom-color-5 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-none" placeholder="<?php echo $lang['notes'] ?>"></textarea>
              </div>
              <div class="u-align-left  u-form-submit u-label-none">
                <button type="button" onclick="submitContactForm(event)" class="mb-2 u-active-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-custom-color-5 u-palette-3-base u-radius-50 u-btn-1"><?php echo $lang['submit'] ?></button>
              </div>
        ...
        <div class="p-5 d-flex justify-content-center flex-column align-items-center">
          <form class="u-clearfix u-form-spacing-28 u-inner-form col-8" style="padding: 0px;" source="email" name="form" method="POST">
            ...
            <div class="u-align-left u-form-submit u-label-none d-flex flex-column">
              <button type="button" onclick="submitContactForm(event)" class="u-active-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-custom-color-5 u-palette-3-base u-radius-50 u-btn-1"><?php echo $lang['submit'] ?></button>
            </div>
            <div class="u-form-send-message u-form-send-success position-relative sucess_message text-center d-none" wfd-invisible="true"> Thank you! Your message has been sent. </div>
            <div class="u-form-send-error u-form-send-message position-relative text-center error_message d-none" wfd-invisible="true"> Unable to send your message. Please fix errors then try again. </div>
            <input dir="rtl" type="hidden" value="" name="recaptchaResponse" wfd-invisible="true">
      ...
      <h1 class="u-align-right u-text u-title u-text-3" style="width: fit-content;" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-direction="Left" data-animation-delay="0" data-animation-out="1" dir="<?php echo $lang['direction'] ?>"> <?php echo $lang["firstBlockTitle"]; ?></h1>
